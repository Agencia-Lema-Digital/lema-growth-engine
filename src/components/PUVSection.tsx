...
export const PUVSection = () => {
  const pillars = ["Personalizado", "Especializado", "Inovador", "Autoral", "Posicionamento"];
  return <section className="py-20 md:py-32 bg-gradient-to-br from-primary/5 to-secondary/5">
